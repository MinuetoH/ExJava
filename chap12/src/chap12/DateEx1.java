 ...
 * 		String format(Date객체) : Date객체를 형식화면 문자열로 리턴
...
public class DateEx1 {
	public static void main(String[] args) {
		...
		SimpleDateFormat sf = new SimpleDateFormat("yyy-mm-dd HH시 mm분 ss초 E a");
		System.out.println(sf.format(now));
		
		SimpleDateFormat sf2 = new SimpleDateFormat("yyy-mm-dd HH:mm:ss E a");
