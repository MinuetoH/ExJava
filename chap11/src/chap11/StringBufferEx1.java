...
public class StringBufferEx1 {
	public static void main(String[] args) {
		...
		if(s1 == s2)
			...
			System.out.println("s1 != s2 : 다른 객체임");
		if(s1.equals(s2))
			System.out.println("s1.equals(s2) : 같은 객체임");
		else
			System.out.println("! s1.equals(s2) : 다른 객체임");
		//내용비교
		if(s1.toString().equals(s2.toString()))
			System.out.println("s1.toString().equals(s2.toString()) : 같은 내용임");
		else
			System.out.println("s1.toString().equals(s2.toString()) : 다른 내용임");
	}
