 ...
 * 		equals : 내용비교를 위한 메서드
 * 		hashCode : 내용비교를 위한 메서드
 * 		toString : 객체의 문자열로 표시해 주기 위한 메서드
 * String : 문자열 객체. 정적문자열. final 클래스
 * 			대입연산자로 객체생성가능. +연산자 가능.
 * StringBuffer/StringBuilder : 동적문자열
 * 								equals 메서드를 오바라이딩 하지 않음. 내용비교를 위해서는 String 변경
 * Math : 수치 계산용 메서드의 집합. 객체생성불가(생성자가 private), final 클래스
 * Wrapper : 8가지 기본료형을 객체화를 하기 위한 클래스들을 통칭
